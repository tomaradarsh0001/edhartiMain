                                ...
                                <thead>
                                    <tr>
                                        <th class="text-center" style="background-color:#116d6e17;">
                                            ...
                                            <h5 class="pb-1">{{customNumFormat(round(43623908123/10000000))}} Cr. (3480 Properties)</h5>
                                        </th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                        ...
                                        <table class="table align-middle table-striped m-0">
                                            ...
                                            <tr>
                                                <td>Lease Hold</td>
                                                <td>{{customNumFormat(round(40993219212/10000000))}} Cr.</td>
                                                <td>895</td>
                                            </tr>
                                            <tr>
                                                <td>Free Hold</td>
                                                <td>{{customNumFormat(round(2630688911/10000000))}} Cr.</td>
                                                <td>2585</td>
                                            </tr>
                                            </tbody>
                                        </table>
